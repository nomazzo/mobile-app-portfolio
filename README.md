...
このリポジトリは、単なるコード置き場ではなく、**実際にアプリを開発・公開・運用してきた経験を、公開可能な形で整理するためのケーススタディ集**です。

---

## 公開方針

このリポジトリに掲載する内容は、実際のアプリ開発経験をもとにしていますが、商用アプリのコードや設定をそのまま公開するものではありません。
...
実際のストアURLや詳細なリリース実績は、必要に応じてエージェント・発注企業向けに個別共有します。
...
* 画像処理、カメラ、ユーティリティ、ストア運用などの強みを示しやすい
* 公開用サンプルへ再構成しやすい
...
このリポジトリは、商用アプリのコードを公開するためのものではありません。

目的は、150本以上のモバイルアプリ開発・公開経験を、公開可能な形で整理し、案件相談や技術確認の材料として使えるようにすることです。
